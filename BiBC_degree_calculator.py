...
if __name__ == '__main__':
    ...
    def assign_node_type(node_list_file, gc_nodes, type1, type2):
        ...
        print("the number of nodes in first list is " + str(len(type1_list)))
        print("the number of nodes in second list is " + str(len(type2_list)))
    ...
    def restricted_betweenness_centrality(G,nodes_0,nodes_1,type):
        ...
        for s in nodes_0:
            ...
            if args.log:
                with open(network_name + "_degree_BiBC_" + node_type1 + "_" + node_type2 + "_LOG.txt", "w") as logfile:
    ...
    network_name = str(args.pickle)
    network_name = network_name.split('.')[0]

    print("!!!!!!!!!!!!!")
    print(network_name)

    with open(network_name + "_degree_BiBC_" + node_type1 + "_" + node_type2 + ".txt", "w") as f:
